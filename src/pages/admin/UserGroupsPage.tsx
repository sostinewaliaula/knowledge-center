                            ...
                            <div className="divide-y divide-gray-100">
                                {filteredGroups.map(group => (
                                    <button
                                        ...
                                        className={`w-full text-left p-4 hover:bg-gray-50 transition-colors flex items-center justify-between group ${selectedGroup?.id === group.id ? 'bg-purple-50 border-l-4 border-purple-600' : 'border-l-4 border-transparent'
                                            }`}
                                    >
